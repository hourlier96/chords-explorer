    ...
    >
      <template #item="{ item: chord, index }">
        <ChordCard
          ...
          :piano="piano"
          @update:model-value="(newChord) => updateChord(index, newChord)"
        ...
        <div class="footer-controls">
          ...
          <div v-if="showQuickImport">
            ...
            <div class="quick-import-buttons">
              <button class="quick-import-button" @click="processQuickImport">
...
const { isMidiEnabled, autoAddWithMidi, detectedChord } =
